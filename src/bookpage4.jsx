...
import room1 from './single1.jpg';
import room2 from './single2.jpg';
import room3 from './single3.jpg';
import room4 from './double4.jpg';
import Footer from "./footer";


const HotelBookingPage4 = () => {
  // Color palette
  const colors = {
    background: '#FFFFF0',
    dark: '#352208',
  ...
  const room = {
    ...
    description: 'Luxurious single-bed room with modern amenities and stunning views...'
  };
    ...
    <div style={{ 
      ...
      <div style={{ flex: 2 }}>
        ...
        <div style={{ marginTop: '2rem', color: colors.dark, backgroundColor: 'white',
          ...
          <h2 style={{ color: colors.accent, marginBottom: '1rem', fontSize: "2.25rem" }}>Single Bed Standard Room</h2>
          <p style={{ fontSize: '1.1rem', lineHeight: 1.6, marginBottom: '2rem' }}>
          Enjoy a luxurious and cozy stay in our Single Bed 5-Star Room, designed for solo travelers who seek comfort, elegance, and modern amenities. With a spacious single bed dressed in premium linens, this room offers the perfect retreat after a long day of business or exploration. The sophisticated interiors and thoughtful details ensure a truly refined experience.          </p>
          ...
          <ul style={{ listStyle: 'none', paddingLeft: '1rem', marginBottom: '2rem' }}>
            <li style={{ marginBottom: '0.5rem' }}>✔ Comfortable Single Bed – Plush mattress with high-quality bedding for a restful sleep</li>
            <li style={{ marginBottom: '0.5rem' }}>✔ Modern Interiors – Elegant furnishings with soft lighting and a soothing ambiance</li>
            <li style={{ marginBottom: '0.5rem' }}>✔ Luxury Bathroom – Featuring a walk-in rainfall shower, designer toiletries, and fluffy bathrobes</li>
            <li style={{ marginBottom: '0.5rem' }}>✔ Advanced Technology – High-speed Wi-Fi, Smart TV, and a functional workspace</li>
            <li style={{ marginBottom: '0.5rem' }}>✔ Scenic Views – Overlooking the city skyline, ocean, or lush green landscapes</li>
            <li style={{ marginBottom: '0.5rem' }}>✔ 24/7 Room Service – Satisfy your cravings with gourmet dining, available anytime</li>
          </ul>
          ...
          Discover the perfect balance of comfort, convenience, and luxury in our Single Bed 5-Star Room. Book your stay today and enjoy an unforgettable hospitality experience!         </p>
        </div>
      </div>
...
export default HotelBookingPage4;