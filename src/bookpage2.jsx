...
import room1 from './twin1.jpg';
import room2 from './twin2.jpg';
import room3 from './twin3.jpg';
import room4 from './twin4.jpg';
import Footer from "./footer";


const HotelBookingPage2 = () => {
  // Color palette
  const colors = {
    background: '#FFFFF0',
    dark: '#352208',
  ...
  const room = {
    ...
    description: 'Luxurious twin-bed room with modern amenities and stunning city views...'
  };
    ...
    <div style={{ 
      ...
      <div style={{ flex: 2 }}>
        ...
        <div style={{ marginTop: '2rem', color: colors.dark, backgroundColor: 'white',
          ...
          <h2 style={{ color: colors.accent, marginBottom: '1rem', fontSize: "2.25rem" }}>Twin Bed Deluxe Room</h2>
          <p style={{ fontSize: '1.1rem', lineHeight: 1.6, marginBottom: '2rem' }}>
          Step into a world of elegance and comfort with our Twin Bed 5-Star Room, designed for both business and leisure travelers. This luxurious space offers two plush twin beds with premium linens, ensuring a restful sleep. The contemporary decor blends modern sophistication with warm tones, creating a serene ambiance for relaxation.
          </p>
          ...
          <ul style={{ listStyle: 'none', paddingLeft: '1rem', marginBottom: '2rem' }}>
            <li style={{ marginBottom: '0.5rem' }}>✔ Spacious Twin Beds – Perfect for shared stays without compromising comfort</li>
            <li style={{ marginBottom: '0.5rem' }}>✔ Elegant Interiors – Thoughtfully designed with high-end furnishings and soft lighting</li>
            <li style={{ marginBottom: '0.5rem' }}>✔ Premium Bathroom – Featuring a walk-in rainfall shower, luxury toiletries, and plush bathrobes</li>
            <li style={{ marginBottom: '0.5rem' }}>✔ State-of-the-Art Technology – High-speed Wi-Fi, Smart TV, and a personal workspace</li>
            <li style={{ marginBottom: '0.5rem' }}>✔ Breathtaking Views – Overlooking the city skyline, ocean, or lush gardens</li>
            <li style={{ marginBottom: '0.5rem' }}>✔ 24/7 Room Service – Indulge in gourmet dining from the comfort of your room</li>
          </ul>

          <h3 style={{ color: colors.accent, marginBottom: '1rem' }}>Exclusive Perks</h3>
          <ul style={{ listStyle: 'none', paddingLeft: '1rem', marginBottom: '2rem' }}>
            <li style={{ marginBottom: '0.5rem' }}>★ Complimentary Breakfast – Start your day with a delightful spread of international and local delicacies</li>
            <li style={{ marginBottom: '0.5rem' }}>★ Access to Spa & Wellness Facilities – Rejuvenate with a spa session or a workout at our state-of-the-art gym (Upon Request)</li>
          ...
          Indulge in luxury and sophistication with our Twin Bed 5-Star Room, where impeccable service and world-class comfort await. Book your stay today for an unforgettable experience!
          </p>
        </div>
      </div>
